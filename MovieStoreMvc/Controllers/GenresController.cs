...
namespace MovieStoreMvc.Controllers
{
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Genre genre)
        {
            ...
            {
                Genre ct = await _context.Genre.FirstOrDefaultAsync(c => c.Name.Equals(genre.Name));
                if (ct != null)
                {
                    return Content("This Genre has already been taken.");
                }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Genre genre)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    Genre ct = await _context.Genre.FirstOrDefaultAsync(c => c.Id != genre.Id && c.Name.Equals(genre.Name));
                    if (ct != null)
                    {
                        return Content("This Genre has already been taken.");
                    }

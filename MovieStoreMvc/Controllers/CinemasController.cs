...
namespace MovieStoreMvc.Controllers
{
    public class CinemasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone,TotalRoom,TotalSeat")] Cinema cinema)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone,TotalRoom,TotalSeat")] Cinema cinema)
        {
            if (id != cinema.Id)
            {
                return NotFound();
